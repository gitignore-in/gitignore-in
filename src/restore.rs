use crate::format::{
    GENERATED_HEADER_LINES as HEADER_LINES, GITIGNORE_IN_FORMAT_PREFIX,
    LEGACY_GENERATED_HEADER_LINES, SEPARATOR,
};
...
pub(crate) fn restore(text: &str) -> String {
    ...
    while let Some(line) = lines.next() {
        ...
        if line.starts_with(GITIGNORE_IN_FORMAT_PREFIX) {
            continue;
        }

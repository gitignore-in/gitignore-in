...
mod tests {
    ...
    #[test]
    fn default_min_overlap_is_required_for_fast_path() {
        // The fast path (restore shortcut) requires all of:
        //   - no explicit gibo/gi targets
        //   - min_overlap equals the default value
        //   - file looks generated
        // This test uses Explicit empty targets to avoid network calls and
        // verifies that a non-default min_overlap produces output different
        // from restore (i.e. the full inference path ran, not the shortcut).
        let generated = "# DO NOT EDIT THIS FILE\n\
            # Generated by gitignore.in\n\
            # See https://gitignore.in/\n\
            # Edit .gitignore.in instead of this file\n\
        ...
        assert_ne!(
            ...
            restore::restore(generated),
            "full inference with no candidates must differ from restore"
        );
    }
